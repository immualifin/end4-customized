...
Scope {
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            margins {
                top: Config.options.bar.vertical ? ((mediaControlsRoot.screen.height / 2) - root.widgetHeight * 1.5) : Appearance.sizes.barHeight
                bottom: Appearance.sizes.barHeight
                left: (mediaControlsRoot.screen.width / 2) - (root.widgetWidth / 2)
                right: 0
            }
